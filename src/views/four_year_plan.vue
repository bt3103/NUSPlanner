<template>
  <div>
    ...
    <p>
      All study plans are generated by real past BZA students four year module plans and we will update every semester to include more combination.<br>
      All modules marked in red are subject to user preference.<br>
      For lists of program elective, please click <a href="https://www.comp.nus.edu.sg/cugresource/per-cohort/ba/ba-18-19/">here</a> to go to BZA official webpages.<br>
      Or you can visit our recommendation page for more insights or create your own study plan by clicking the View Button.
    </p>
